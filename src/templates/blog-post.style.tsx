...
export const ContentMetaContainer = styled.div<
  React.HTMLAttributes<HTMLDivElement> & IOptionalPadding
>`
  width: 100%;
  max-width: var(--container-width);
...
>) {
  return (
    <ContentMetaWrapper>
      <ContentMetaContainer {...props}>{children}</ContentMetaContainer>
    </ContentMetaWrapper>
  );
}
...
>) {
  return (
    <ContentDividerWrapper>
      <ContentDividerContainer {...props}>{children}</ContentDividerContainer>
    </ContentDividerWrapper>
  );
}
